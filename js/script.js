...
document.getElementById('envio').addEventListener('click', function(event) {
	event.preventDefault();
	alert("LO SENTIMOS, NO SE PUEDE ENVIAR MENSAJES POR EL MOMENTO. INTENTE MÁS TARDE.");
  });

document.getElementById('Descarga').addEventListener('click', function(event) {
	event.preventDefault();
	alert("LO SENTIMOS, LA APLICACIÓN NO ESTÁ DISPONIBLE. INTENTE MÁS TARDE.");
  });
